...
ECR_REPO="111111111111.dkr.ecr.us-east-1.amazonaws.com/ue1prd-ecr-name"
AWS_REGION="us-east-1"

# Images built from local use manual tag
IMAGE_TAG="manual"
...
# Update RUNTIME_ID with your AgentCore runtime ID
RUNTIME_ID="YOUR_RUNTIME_ID_HERE"
...
# Use Terraform-defined lifecycle values (match your tfvars file)
...
echo ""
echo "Next step: Send a message to Vera bot in Slack"
